...
class RentalPropertiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rental_property" do
    assert_difference('RentalProperty.count') do
      post rental_properties_url, params: { rental_property: { address: @rental_property.address, age: @rental_property.age, name: @rental_property.name, nearest_station_id: @rental_property.nearest_station_id, note: @rental_property.note, rent: @rental_property.rent } }
    end
  ...
  test "should update rental_property" do
    patch rental_property_url(@rental_property), params: { rental_property: { address: @rental_property.address, age: @rental_property.age, name: @rental_property.name, nearest_station_id: @rental_property.nearest_station_id, note: @rental_property.note, rent: @rental_property.rent } }
